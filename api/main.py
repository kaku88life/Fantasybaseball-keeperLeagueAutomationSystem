...
async def debug_users():
    """Temporary debug endpoint to identify users without nicknames.
    TODO: Remove this endpoint after user identification is complete.
    """
    ...
    try:
        rows = _fetchall(
            ...
            """SELECT u.id, u.yahoo_guid, u.yahoo_nickname, u.yahoo_email,
                      u.team_id, u.is_commissioner, u.last_login, u.line_name,
            ...
            "users": [
                {
                    ...
                    "yahoo_nickname": r.get("yahoo_nickname", ""),
                    "yahoo_email": r.get("yahoo_email", ""),
                    "team_id": r.get("team_id"),
                    "manager_name": r.get("manager_name", ""),
                    "team_name": r.get("team_name", ""),
                    "is_commissioner": r.get("is_commissioner", 0),
